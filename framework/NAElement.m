...
{
	return [[NAElement alloc] initWithName:aName content:nil];
}

+ (NAElement*) elementWithName:(NSString*)aName content:(NSString*)aContent
{
	return [[NAElement alloc] initWithName:aName content:aContent];
}

+ (NAElement*) elementWithName:(NSString*)aName children:(NAElement*)firstChild, ...
{
	NAElement *elem = [[NAElement alloc] initWithName:aName content:nil];
	if (firstChild != nil) {
		id child;
